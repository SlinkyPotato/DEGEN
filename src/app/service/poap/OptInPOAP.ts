...
const OptInPOAP = async (_: User, __: DMChannel): Promise<void> => {
	// Log.debug('starting opt-in check for user');
	// TODO: handle opt in for eth wallet delivery
	...
	//	
	// } else {
	// 	// TODO: handle eth wallet dm check
	// 	// isAllowedToGetDMs = userSettings.isDMEnabled;
	// }
	
	// if (!isAllowedToGetDMs) {
	// TODO: ask to opt in to eth delivery
